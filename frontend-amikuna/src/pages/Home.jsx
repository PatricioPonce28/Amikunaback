...
import icons from "../assets/facebook.png";
import icons2 from "../assets/gogle.png";
import icons3 from "../assets/twitter.png";
  ...
  return (
    <div className="w-full flex flex-col min-h-screen justify-between">
      ...
      <section className="w-full px-4 mt-10">
        <div className="bg-white bg-opacity-80 p-8 rounded-lg shadow-lg border border-gray-300 text-black text-base sm:text-lg md:text-xl leading-relaxed max-w-7xl mx-auto">
          <p>
      ...
      <footer className="mt-10 text-sm text-gray-400 text-center py-6">
        <div className="flex justify-center mb-4 space-x-6">
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer">
            <img src={icons} alt="Facebook" className="w-8 h-8 hover:scale-110 transition-transform" />
          </a>
          <a href="https://google.com" target="_blank" rel="noopener noreferrer">
            <img src={icons2} alt="Google" className="w-8 h-8 hover:scale-110 transition-transform" />
          </a>
          <a href="https://twitter.com" target="_blank" rel="noopener noreferrer">
            <img src={icons3} alt="Twitter" className="w-8 h-8 hover:scale-110 transition-transform" />
          </a>
        </div>
